...
3.1. Можете да контролирате и/или изтривате бисквитки по ваше желание. За повече информация вижте aboutcookies.org.

3.2. Можете да изтриете всички бисквитки, които вече са запазени на вашето устройство, а също така можете да настроите повечето браузъри да ги блокират. Ако направите това обаче, може да се наложи ръчно да коригирате някои настройки всеки път, когато посещавате Сайта, а някои услуги и функции може да не работят.

## 4. Промени в Политиката за бисквитките

4.1. Запазваме си правото да актуализираме тази Политика за бисквитките по всяко време. Промените влизат в сила веднага след публикуването им на Сайта.

## 5. Съгласие

5.1. С продължаването на използването на Сайта, вие се съгласявате с използването на бисквитки в съответствие с тази Политика за бисквитките.
    `,
  };
