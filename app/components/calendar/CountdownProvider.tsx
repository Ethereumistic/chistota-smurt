...
export const CountdownProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  const endDates = [
    DateTime.fromObject({ year: 2025, month: 10, day: 15, hour: 9 }), // Sofia
    DateTime.fromObject({ year: 2025, month: 10, day: 15, hour: 9 }), // Plovdiv
    DateTime.fromObject({ year: 2025, month: 10, day: 15, hour: 9 }),  // Burgas
    DateTime.fromObject({ year: 2025, month: 10, day: 15, hour: 9 }), // Varna
  ];
