...
const Countdown = (): ReactElement | null => {
  ...
  <div className="flex flex-col items-center justify-center space-y-10">
    ...
    <div className="flex space-x-1 lg:space-x-10 xxs:scale-100 scale-75">
...
<Link href={`/buy?tab=${title}`} className='hover-highlight-link hover:scale-110 transition-all duration-700'>
  <div className='hover-highlight-container'>
    ...
    <p className="text-base uppercase text-zinc-800 ">{time}</p>
      ...
      <div className=" flex items-center gap-1.5 text-end text-base uppercase  text-black hover:scale-110 transition-all duration-700">
          <p>{location}</p>
          <IconMapPin />
      </div>
        </Link>
