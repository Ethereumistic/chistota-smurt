...
const MobileMenu: React.FC<MobileMenuProps> = ({ isOpen, onClose }) => {
  ...
  <div className="space-y-16 mb-10">
    <div className="flex flex-col justify-center items-center text-center space-y-10 w-full">
        <TicketsButton className="w-[80%] justify-center" onClick={onClose} />
        <TherapyButton className="w-[80%] justify-center" onClick={onClose}  />
    {/* </div>
    <div className="space-y-8 mb-10"> */}
        <PartnersButton className="w-[80%] justify-center" onClick={onClose} />
        <AboutButton className="w-[80%] justify-center" onClick={onClose} />
    </div>
